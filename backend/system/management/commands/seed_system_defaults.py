...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        settings = [
            ...
            {'key': 'svt_expiry_minutes', 'value': '20', 'category': 'security', 'description': 'SVT lifetime in minutes after issue (before validation)'},
            {'key': 'svt_max_requests_total', 'value': '3', 'category': 'security', 'description': 'Max SVT requests per voter per election (lifetime)'},
            {'key': 'svt_max_requests_per_hour', 'value': '3', 'category': 'security', 'description': 'Legacy alias — prefer svt_max_requests_total'},
            ...
            {'key': 'svt_cross_user_block_minutes', 'value': '60', 'category': 'security', 'description': 'Lockout minutes when a voter tries another voter’s live SVT'},
