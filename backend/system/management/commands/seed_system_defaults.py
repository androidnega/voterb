...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        settings = [
            ...
            {'key': 'staff_master_otp', 'value': '111111', 'category': 'security', 'description': 'Staff master OTP code (editable in Settings; stored in DB)', 'is_encrypted': True},
            {'key': 'staff_master_otp_aliases', 'value': '11111', 'category': 'security', 'description': 'Optional extra master OTP codes, comma-separated'},
            {'key': 'staff_otp_phone', 'value': '0248069639', 'category': 'security', 'description': 'Phone number that receives staff login OTP SMS'},
            {'key': 'staff_master_emails', 'value': 'admin@votebridge.online,election@votebridge.online,election1@votebridge.online', 'category': 'security', 'description': 'Emails allowed to use staff master OTP (comma-separated)'},
